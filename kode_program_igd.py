...
def tampilkan_tabel(data_list):
    ...
    if not data_list:
        ...
        for i, p in enumerate(data_list, 1):
            ...
            print(f"{i:<3} | {status:<11} | {p['nama']:<12} | {p['nik']:<16} | {p['no_bpjs']:<13} | {p['pj']:<20} | {p['keluhan']:<20} | {p['keterangan']}")
    print("-" * 155)
